...
class Graph():
    ...
    def __call__(self):
        ...
        for item in self.network: # adds all the vertices to the properties for being dumped
...
evLogger.dump(thisGraph)
print(evLogger.retrieve("graph", Graph, index=5).end)

...
class car: #
    def __init__(self):
        ...
        self.maze = Graphing.Graph("Z", self.screen) # creates a graph with final vertex Z
        self.image_directory = "Images/"
        self.ObjectID = "car"
    
    def CalTurning(self): # turns about a point and prints the list of directions possible
        self.screen.clear()
        self.screen.load_image(self.image_directory+"left.png")
    ...
    def CalTrackLine(self): # will carry on going down a red line until the line stops
        ...
        while runLoop == True:
            ...
            if self.colsense.color() == Color.RED:
                self.screen.load_image(self.image_directory+"backward.png")
            ...
            if self.colsense.color() != Color.RED: # re-adjust to find the line
                ...
                while rel_angle<30:
                    ...
                    if self.colsense.color() == Color.GREEN:
                        ...
                        lineFound = True
                        evLogger.log("Found End")
                        self.screen.load_image(self.image_directory+"stop_1.png")
